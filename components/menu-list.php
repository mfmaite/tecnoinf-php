<?php
  ...
  $sortParam = isset($_GET['sort']) ? $_GET['sort'] : 'name_asc';
    ...
    <div class="d-flex align-items-center">
      <div class="sort-controls mr-3">
        <select class="custom-select" onchange="window.location.href = '?sort=' + this.value">
          <option value="name_asc" <?= $sortParam === 'name_asc' ? 'selected' : '' ?>>
            Nombre (A-Z)
          </option>
          <option value="name_desc" <?= $sortParam === 'name_desc' ? 'selected' : '' ?>>
            Nombre (Z-A)
          </option>
          <option value="price_asc" <?= $sortParam === 'price_asc' ? 'selected' : '' ?>>
            Precio (Menor a Mayor)
          </option>
          <option value="price_desc" <?= $sortParam === 'price_desc' ? 'selected' : '' ?>>
